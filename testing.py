...
def analysis():
    ...
    for num, data in enumerate(verify_data):
        ...
        myobj=gTTS(text=str_label,lang='en',slow=False)
        myobj.save("tts.mp3")
        song=MP3("tts.mp3")
        pygame.mixer.init()
        ...
        if str_label == 'Parkinson':
            
            status='Parkinson'

        elif str_label == 'No Parkinson':
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:\\Users\\91636\\Desktop\\Parkinson\\test\\', title='Select image for analysis ',
